...
namespace mlLinuxPath
{

    public class LinuxPath : PathBase
    {
        //PUBLIC STATIC
        ...
        //ENCODING
        public LinuxPath(EncodedObject encodedObject) : base(PathStructure, encodedObject) { }
        public override void Encode(ref EncodedObject encodedObj) => base.Encode(ref encodedObj);
        ...
        static LinuxPath()
        {
            ...
            DDEncoder.DDEncoder.RegisterType(typeof(LinuxPath));
        }
        ...
        public override Stream OpenStream(FileMode fileMode, FileAccess fileAccess, FileShare fileShare)
        {
            ...
            catch (FileNotFoundException e)
            {
                ...
                throw new PathAccessException(this, $"File does not exist and FileMode was *not* set to CreateNew or Create: {Path}", e);
            }
            catch (DirectoryNotFoundException e)
            {
                SetExists(false);

                throw new PathAccessException(this, $"Parent directory does not exist, cannot create/open file: {Path}", e);
            }
            catch (IOException e)
            {
                SetExists(true);
                ...
                throw new PathAccessException(this, $"{Path}: {msg}", e);
            }
