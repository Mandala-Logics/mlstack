...
namespace mlStringValidation
{
    ...
    public enum StringValidationFlags : int
    {
        ...
        None = 0,
        /// <summary>
        /// Automatically capatlises the first letter of a string.
        /// </summary>
        AutoCapatliseFirst = 0b1,
        /// <summary>
        /// Automatically capatalises the first letter of each word, as in a name.
        /// </summary>
        ...
        /// <summary>
        /// Allowes letters, numbers and filename chars.
        /// </summary>
        FileName = Alphanumeric | AllowFileNameChars | AutoTrim,
        /// <summary>
        /// Allows letters, auto capatilises each word in the string and automatically trims each word.
        /// </summary>
        ...
        /// <summary>
        /// Allows letters, only one word allowed, auto-trims and automatically capatilises the first letter of the string.
        /// </summary>
        ProperNoun = AllowWordChars | AllowLetters | AutoTrim | AutoCapatliseFirst,
        /// <summary>
        /// Allows numbers with number chrachters, for e.g. -9.872
        /// </summary>
    ...
    public sealed class StringTemplate : IEncodable, IEquatable<StringTemplate>
    {
        ...
        private readonly static System.Text.RegularExpressions.Regex wordSplitter = new System.Text.RegularExpressions.Regex(@"(?<word>[^\s]+)(?<spaces>\s+)?");

        //PUBLIC STATIC FIELDS
        public readonly static char[] FileNameChars = new char[] { '-', '_', '.', ')', '(', '[', ']', '&', ':', ';', '+', '-', '=', '@', '\'', '%', '£', '$', '#', '*' };
        public readonly static char[] WordChars = new char[] { '\'', '-', '_' };
        public readonly static char[] NumberChars = new char[] { '.', '-' };
        ...
        public StringTemplate(EncodedObject obj)
        {
            Flags = (StringValidationFlags)obj.Next<int>();
            Addititional = obj.Next<char[]>();
            MinWords = obj.Next<int>();
            MaxWords = obj.Next<int>();
            MinLength = obj.Next<int>();
            MaxLength = obj.Next<int>();

            string s = obj.Next<string>();
        ...
        {
            encodedObj.Append((int)Flags);
            encodedObj.Append(Addititional);
            encodedObj.Append(MinWords);
            encodedObj.Append(MaxWords);
            encodedObj.Append(MinLength);
            encodedObj.Append(MaxLength);
            encodedObj.Append(FormatRegex.ToString());
        }
